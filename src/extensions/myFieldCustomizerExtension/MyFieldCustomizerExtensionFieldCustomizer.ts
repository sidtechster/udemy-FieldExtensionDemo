...
export default class MyFieldCustomizerExtensionFieldCustomizer
  ...
  public onRenderCell(event: IFieldCustomizerCellEventParameters): void {
    ...
    event.domElement.innerHTML = `<div class='${styles.MyFieldCustomizerExtension}'><div class='${styles.cell}'><div style='background:#107c10;width:${event.fieldValue}px;color:white;'>${event.fieldValue}%</div></div></div>`;
  }
